...
Содержание:
- Поля: id, название, описание, приоритет, статус, назначенный разработчик, дата создания, дата изменения
- Методы:
  - Конструкторы
  - Геттеры/сеттеры
...
Назначение: Диалог создания/редактирования задачи
Содержание:
